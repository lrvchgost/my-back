...
class ValidateDescriptionNotEmtpyTest {
    @Test
    fun emptyString() = runTest {
        val ctx = CatalogContext(state = CatalogState.RUNNING, storageValidating = Storage(description = ""))
        chain.exec(ctx)
